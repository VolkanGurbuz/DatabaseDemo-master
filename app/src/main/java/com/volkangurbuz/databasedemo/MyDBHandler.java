package com.volkangurbuz.databasedemo;
...
public class MyDBHandler extends SQLiteOpenHelper {
    ...
    public void urunEkle(com.volkangurbuz.databasedemo.Urun urun) {
    ...
    public com.volkangurbuz.databasedemo.Urun urunBul(String urunadi) {
        String query = "Select * FROM " + TABLE_URUNLER +
                " WHERE " + COLUMN_URUNADI + " =  \"" + urunadi + "\"";
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(query, null);

        com.volkangurbuz.databasedemo.Urun urun = new com.volkangurbuz.databasedemo.Urun();
